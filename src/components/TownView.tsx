  ...
  <aside className="scroll-thin min-h-0 space-y-4 overflow-y-auto border-l border-[#d5dbce] bg-[#f6f3e9] p-4">
   ...
   <section className="space-y-3 border-t border-[#d9ded1] pt-3">
    ...
    {!proposal.maxed&&<>
     ...
     {project==='inn'&&proposal.trafficPressure>0&&<p className="rounded-lg bg-amber/10 p-2 text-xs">Access shortage: recent demand exceeded arrival capacity. Resident support is reduced by {proposal.trafficPressure} points. Expand transport or moderate demand; this pressure clears as those days leave the seven-day window.</p>}
