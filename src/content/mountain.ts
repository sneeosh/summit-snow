...
import { DEFAULT_MOUNTAIN_ID, LEGACY_MOUNTAIN_MAP, MOUNTAIN_MAP, REVISION_TWO_MAP } from './mountains'
...
export function ensureMountain(mountainId: string | undefined, version: 1 | 2 | 3 = 3): void {
  const id = mountainId && MOUNTAIN_MAP[mountainId] ? mountainId : DEFAULT_MOUNTAIN_ID
  const def = (version === 1 ? LEGACY_MOUNTAIN_MAP : version === 2 ? REVISION_TWO_MAP : MOUNTAIN_MAP)[id]
