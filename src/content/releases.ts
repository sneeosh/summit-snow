...
export const RELEASES = [
  {
    ...
    title: 'A livelier mountain town',
    ...
    changes: [
      ...
      'Watch snow fall, neighbors stroll, and cars pass through town.',
      'Explore eight mountains with distinct terrain, scenery, and operating goals.',
